      ...
      <section className="home-hero-shell" aria-labelledby="home-title">
        <div className="hero-copy">
          ...
          <div className="shuffle-mode-panel">
            ...
            <div className="shuffle-mode-switch-card" aria-label="Shuffle mode selector">
              <div className="shuffle-mode-switch-heading">
                <span>Switch setup mode</span>
                <small>{shuffleMode === 'daily' ? 'Daily is on' : 'Random is on'}</small>
              </div>
              <div className="shuffle-mode-toggle" role="group" aria-label="Choose global shuffle mode">
                {(['daily', 'random'] as const).map((mode) => (
                  ...
                  >
                    <span>{mode === 'daily' ? 'Daily Shuffle' : 'Random Shuffle'}</span>
                    <small>{mode === 'daily' ? 'Same board today' : 'Fresh every game'}</small>
                  </button>
                ))}
              </div>
            </div>
