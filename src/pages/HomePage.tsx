        ...
        <div className="hero-copy">
          ...
          <div className="home-action-grid" aria-label="Choose how to play">
            <button type="button" className="home-action-card home-action-ai" onClick={playActiveModeAgainstAi}>
              ...
              <img className="action-piece action-piece-pawn action-piece-pawn-primary" src="/pieces/white-pawn.png" alt="White pawn" draggable={false} />
              <img className="action-piece action-piece-pawn action-piece-pawn-secondary" src="/pieces/white-pawn.png" alt="" aria-hidden="true" draggable={false} />
              <img className="action-piece action-piece-pawn action-piece-pawn-tertiary" src="/pieces/white-pawn.png" alt="" aria-hidden="true" draggable={false} />
