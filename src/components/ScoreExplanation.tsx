...
export function ScoreExplanation({ breakdown, resultLabel }: ScoreExplanationProps) {
  ...
  return (
    <div className="score-help-shell">
      ...
      {isOpen && createPortal(
        <div className="score-help-modal-backdrop" onClick={() => setIsOpen(false)}>
          <aside className="score-help-drawer" role="dialog" aria-modal="true" aria-labelledby="score-help-title" onClick={(event) => event.stopPropagation()}>
